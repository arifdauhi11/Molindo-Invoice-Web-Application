      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Tambah Pengeluaran</h3>
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard') ?>">Dashboard</a>
                  </li>
                  <li class="breadcrumb-item active">Tambah Pengeluaran
                  </li>
                </ol>
              </div>
            </div>
                    ...
                    <form id="formInvoice" class="form" method="POST" enctype="multipart/form-data" action="<?php echo base_url('pengeluaran/add_action/') ?>">
                      <div class="form-body">
                        ...
                        <div class="form-group">
                          ...
                          <input id="anggaranTerpakai" name="terpakai" class="form-control border-primary" type="text" placeholder="Masukkan Anggaran Terpakai" value="<?= set_value('terpakai') ?>">
