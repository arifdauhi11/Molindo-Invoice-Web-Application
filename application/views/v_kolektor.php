      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Kolektor</h3>
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard') ?>">Dashboard</a>
                  </li>
                  <li class="breadcrumb-item active">Kolektor
                  </li>
                </ol>
              </div>
            </div>
        ...
        <br>
          <div class="content-body">
            <section id="simple-user-cards" class="row">
              <div class="col-12">
                  <h4 class="text-uppercase">List Kolektor</h4>        
              </div>
                  ...
                  <div class="card">
                      <div class="text-center">
                          ...
                          <div class="card-footer">
                              ...
                              <?php } ?>                                                            
                              <form class="form" method="POST" action="<?php echo site_url('kolektor/updateSignature/'.$key->id_user."/".$key->signature."/".$key->nama_user) ?>" enctype="multipart/form-data">
